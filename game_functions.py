...
def crash_sound(sound):
    sound.crash_sound.play()


def pip_sound(sound):
    sound.pip_sound.play()
...
def check_events(ai_settings, screen, stats, sb, paly_button, ship, aliens,
                 bullets, sound):
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(ai_settings, screen, stats, sb, paly_button,
                              ship, aliens, bullets, mouse_x, mouse_y, sound)
...
def check_play_button(ai_settings, screen, stats, sb, play_button, ship,
    ...
    if button_clicked and not stats.game_active:
        ...
        sound.play_button.play()
        fon_music()


def update_screen(background, screen, stats, sb, ship, aliens, bullets,
                  play_button):
